...
def main(args):
    ...
    model = SegmentationModel(args.model, learning_rate=args.learning_rate, weight_decay=args.weight_decay)
    ...
    plot_dataset = FloatingSeaObjectDataset(args.data_path, fold="val",
                                             transform=get_transform("test", add_fdi_ndvi=False, cropsize=args.image_size),
                                             output_size=args.image_size, hard_negative_mining=False,
