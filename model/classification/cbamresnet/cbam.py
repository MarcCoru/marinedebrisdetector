...
class Spatial_Attention(nn.Module):
    ...
    def __init__(self, kernel_size=7, return_attention=False):
...
class CBAM(nn.Module):
    '''CBAM architecture.
    '''
    def __init__(self, channel_in, reduction_ratio=16, pool_types=['avg', 'max'], spatial=True, spatial_kernelsize=3, return_attention=False):
        ...
        if self.spatial:
            self.spatial_attention = Spatial_Attention(kernel_size=spatial_kernelsize, return_attention=return_attention)
