python train_segmentation.py --data-path /data/marinedebris --model unet++ --batch-size 256 --project flobs-segm --weight-decay 1e-8 --run-name unet++_2022-10-21
python train_segmentation.py --data-path /data/marinedebris --model unet++ --batch-size 256 --project flobs-segm --weight-decay 1e-6 --run-name unet++_2022-10-21-1e6
